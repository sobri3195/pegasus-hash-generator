...
"""
__Author__  = Muhammad Sobri Maulana
__Name__    = Pegasus hash generator
__version__ = 3.4.1
__Code__    = python
__Github__  = https://github.com/sobri3195
__Date__    = 6/6/19
__Team__    = Cyber Security Down
__License__ = GNU General Public License V.3

(c) Muhammad Sobri Maulana 2018
